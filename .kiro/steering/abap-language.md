...
inclusion: auto
name: abap-language
description: "ABAP language quick reference: data types, internal tables, ABAP SQL, constructor expressions, OO ABAP, version compatibility (7.40 through Cloud)."
---
